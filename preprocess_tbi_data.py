...
neg_data_dir = "/gpfs/data/dmerck/tbi_data/orig/neg/nii/"
...
resampled_neg_data = "/gpfs/data/dmerck/tbi_data/resampled/neg/"
...
brain_neg_data = "/gpfs/data/dmerck/tbi_data/final3/bet/neg/"
brain_neg_std_data = "/gpfs/data/dmerck/tbi_data/final3/bet/std/neg/"
...
def resample_everything(data_dir, seg_dir, new_data_out, new_seg_out=None):
	...
	# Negative files have a different file structure.
	if not new_seg_out:
		ct_files = [directory+"/"+directory+".nii.gz" for directory in os.listdir(data_dir)]
	if new_seg_out:
...
# resample_everything(neg_data_dir, None, resampled_neg_data)
...
finish_preprocessing(resampled_neg_data, brain_neg_data, None, brain_neg_std_data)
